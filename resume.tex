...
\begin{paracol}{2}
    ...
    \cvsection{Work Experience}
        ...
        \cvevent{COVID-19 Response Public Health Officer}{Government of the Northwest Territories}{May 2020 - Aug. 2020}{Inuvik, NT}
            \begin{itemize}
                \item Protect the community of Inuvik from exposure to COVID-19 by processing individuals entering the community 
...
\cvsection{Extracurriculars}
    ...
    \begin{itemize}
        \item Increase the accuracy of the Kalman filter in the navigation system of the hyperloop pod
        ...
        \item \textbf{Technologies}: C/C++, Python 
    \end{itemize}
