...
\begin{paracol}{2}
    \cvsection{Education}
        ...
        \begin{itemize}
            \item Graduation Date: September 1st, 2022
            \item \textbf{Relevant Coursework}: Digital Circuit Design, Integrated Circuit Design, 
    ...
    \cvsection{Work Experience}
        \cvevent{Project Assistant (Summer Internship)}{Government of the Northwest Territories}{Apr. 2019 - Aug. 2021}{Inuvik, NT}
            \begin{itemize}
                 \item Streamline information from the project officers to the regional projects manager by building and upgrading tools 
