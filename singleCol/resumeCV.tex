...
\vspace{-25pt} % Set a negative value to push the body up, and the opposite
...
\section{\faPieChart}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem {Create flexible, low-cost and highly tunable circuit designs for bias and control of mmWave guide switches}
      \resumeItem {Devise comprehensive testing plans to evaluate completed circuit and PCB Designs}
      \resumeItem {}
      \resumeItem {\textbf{Technologies:} KiCAD, LTSpice, Laser Diodes, LED Drivers, Keysight Oscilloscopes, }
    \resumeItemListEnd
  \resumeEntryEnd

  % \resumeEntryStart
  % \resumeEntryTSDL
  % {University of Alberta}{Jun. 2022 -- Dec. 2024}
...
\section{\faGraduationCap}{Education}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Relevant Coursework: Digital Electronics, Embedded System Design, Integrated Circuit Design}
  \resumeItemListEnd
  \resumeEntryEnd
...
\resumeEntryTD{Personal}{}%Powerlifting, Music, Linguistics, Running, Photography, Reading, Curling, PC Building, Gaming}
   ...
   \resumeItem{Powerlifting: Avid powerlifting competitore}
   \resumeItem{Reading: Taking time toreading more often. Current interests: Neurology, Psychology, Electrical Engineering}
   \resumeItem{Cooking: Enjoy learning a new recipe and cooking for friends and family}
